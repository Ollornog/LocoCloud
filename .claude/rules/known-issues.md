...
| Vaultwarden API ≠ Admin-Token | `/api/ciphers` braucht User-JWT (OAuth2 Login) + client-seitige Verschlüsselung. Admin-Token nur für `/admin/`. `credentials`-Rolle nutzt `bw` CLI oder lokale Pending-Datei. |
