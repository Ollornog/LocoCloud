...
| Offene Entscheidung getroffen | `docs/KONZEPT.md` Kapitel 23 aktualisieren, als gelöst markieren |
...
| Security-Änderung | `docs/KONZEPT.md` Kapitel 18, `.claude/rules/known-issues.md` |
| Neuer Kunde ongeboardet | Compliance-Dokumente regenerieren (`generate-docs.yml`) |
| App hinzugefügt/entfernt | VVT automatisch aktualisiert (via `compliance`-Rolle) |
...
- **Keine TODO-Kommentare** im Code. Offene Punkte → `docs/KONZEPT.md` Kapitel 23 oder GitHub Issue
